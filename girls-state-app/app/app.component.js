System.register(['angular2/core', './auxiliary/auxiliary-role-creator.component', './student/student-application.component', './student/parent-consent-form.component', './shared/student-school-login.component', './auxiliary/create-auxiliary-account.component', './auxiliary/auxiliary-login.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, auxiliary_role_creator_component_1, student_application_component_1, parent_consent_form_component_1, student_school_login_component_1, create_auxiliary_account_component_1, auxiliary_login_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
                ...
                AppComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [auxiliary_role_creator_component_1.AuxiliaryRoleCreatorComponent, student_application_component_1.StudentApplicationComponent, parent_consent_form_component_1.ParentConsentFormComponent,
                            student_school_login_component_1.StudentSchoolLoginComponent, create_auxiliary_account_component_1.CreateAuxiliaryAccountComponent, auxiliary_login_component_1.AuxiliaryLoginComponent]
                    }), 
